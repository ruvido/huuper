...
var paymentTemplateKindAllowedValues = []string{
	"events.user.registration_received",
	"events.user.registration_accepted",
	"events.user.payment_link",
...
func init() {
	m.Register(func(app core.App) error {
		...
		case *core.SelectField:
			field.Values = paymentTemplateKindAllowedValues
		case nil:
			templates.Fields.Add(&core.SelectField{
				Name:     "kind",
				Required: false,
				Values:   paymentTemplateKindAllowedValues,
			})
		default:
