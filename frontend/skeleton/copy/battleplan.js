window.appCopy = Object.assign({}, window.appCopy || {}, {
  battleplan: {
    ...
    wizardShared: {
      ...
      endDateCustomPrompt: "Choose a specific end date",
      endDatePresetsPrompt: "Standard deadlines",
      ...
      priorityEndDateMeta: "{days} days remaining ({date})",
      priorityEndDateMetaSingular: "{days} day remaining ({date})",
    },
    placeholder: {
