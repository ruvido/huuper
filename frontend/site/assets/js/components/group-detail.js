window.huuperGroupDetail = (() => {
  ...
  function init(config) {
    ...
    if (!statusNode || !tabsNode || !tabMembersNode || !tabPendingNode || !pendingSectionNode || !pendingNode || !membersSectionNode || !membersNode || !window.huuperAuth || !window.huuperListPage || !window.huuperRequestItem || !window.huuperListItem) {
      return;
    }
